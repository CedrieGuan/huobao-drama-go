...
final class SettingsViewModel: ObservableObject {
    ...
    static let huobaoPresetCards: [PresetCard] = [
        .init(
            serviceType: "text", label: "文本", provider: "chatfire",
            baseUrl: "https://api.chatfire.site", model: "gemini-3-pro-preview"),
        .init(
            serviceType: "image", label: "图片", provider: "gemini",
            baseUrl: "https://api.chatfire.site", model: "gemini-3-pro-image-preview"),
        .init(
            serviceType: "video", label: "视频", provider: "volcengine",
            baseUrl: "https://api.chatfire.site/volcengine", model: "doubao-seedance-1-5-pro-251215"
        ),
        .init(
            serviceType: "audio", label: "音频", provider: "minimax",
            baseUrl: "https://api.chatfire.site/minimax", model: "speech-2.8-hd"),
    ]
    ...
    static let providerPresets: [String: [String: ProviderPreset]] = [
        "text": [
            "chatfire": .init(
                provider: "chatfire", label: "ChatFire 推荐", baseUrl: "https://api.chatfire.site",
                models: ["gemini-3-pro-preview"]),
            "openrouter": .init(
                provider: "openrouter", label: "OpenRouter 推荐",
                baseUrl: "https://openrouter.ai/api", models: ["google/gemini-3-flash-preview"]),
            "openai": .init(
                provider: "openai", label: "OpenAI 推荐", baseUrl: "https://api.openai.com",
                models: ["gpt-4.1-mini"]),
        ],
        "image": [
            "chatfire": .init(
            ...
            "gemini": .init(
                provider: "gemini", label: "Gemini 推荐", baseUrl: "https://api.chatfire.site",
                models: ["gemini-3-pro-image-preview"]),
            "volcengine": .init(
                provider: "volcengine", label: "火山推荐", baseUrl: "https://ark.cn-beijing.volces.com",
                models: ["doubao-seedream-4-0-250828"]),
        ],
        "video": [
            "volcengine": .init(
                provider: "volcengine", label: "火宝视频",
                baseUrl: "https://api.chatfire.site/volcengine",
                models: ["doubao-seedance-1-5-pro-251215"]),
            "vidu": .init(
                provider: "vidu", label: "Vidu 推荐", baseUrl: "https://api.vidu.com",
                models: ["viduq3-turbo"]),
            "ali": .init(
                provider: "ali", label: "阿里推荐", baseUrl: "https://dashscope.aliyuncs.com",
                models: ["wan2.6-i2v-flash"]),
        ],
        "audio": [
            "minimax": .init(
                provider: "minimax", label: "火宝音频", baseUrl: "https://api.chatfire.site/minimax",
    ...
    func saveAgentConfig(
        ...
        let label = Self.agentDefs.first { $0.type == agentType }?.label ?? agentType
